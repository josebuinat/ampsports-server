...
VCR.configure do |conf|
  ...
  conf.cassette_library_dir = Rails.root.join('spec/fixtures/vcr_cassettes')
...
=end
  ...
  Capybara.register_driver :poltergeist do |app|
    ...
    Capybara::Poltergeist::Driver.new(app,
                                      inspector: false,
                                      timeout: 300, # setting this to 30 causes cirleCI builds to fail consistently
                                      debug: false,
...
RSpec::Matchers.define_negated_matcher :do_not_change, :change
