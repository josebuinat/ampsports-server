    ...
    return(
      <Modal.Body>
        <form action={this.state.membership.update_url}
          ...
          <div className="row">
            <div className="col-md-9">
              <div className="form-group has-feedback">
                  <label className="control-label">{ I18n.t('venues.memberships_new.title_label')}</label>
                  <input type="text" className="form-control" placeholder={ I18n.t('venues.memberships_new.title_label')}  name="membership[title]" defaultValue={this.state.membership.title}/>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-9">
              <Select2 label={ I18n.t('venues.memberships_new.select_court_label')}
                      ...
                      multiple='multiple'
                      name="court_ids[]"
                      initialValue={this.state.membership.courts}
                      required />
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-9">
              <div className="form-group has-feedback">
                  ...
                  <i className={`fa fa-${this.props.currency} form-control-feedback`}></i>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-9">
              <label className="control-label">{I18n.t('venues.memberships_new.membership_note')}</label>
              <FormControl componentClass="textarea"
                           name="membership[note]"
                           defaultValue={this.state.membership.note}
                           placeholder={I18n.t('venues.memberships_new.note')} />
            </div>
          </div>
       </form>
      </Modal.Body>
