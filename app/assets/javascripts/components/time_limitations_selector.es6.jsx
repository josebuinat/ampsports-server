...
class TimeLimitationsSelector extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <Row className="clearfix">
          <Col md={12}>
            <div onClick={this.handleTimeLimitationsAdd.bind(this)}
              ...
              {I18n.t('shared.time_limitations_selector.add_time_limit')}
            </div>
          </Col>
        </Row>
      </FormGroup>
  ...
  render_limits() {
    if (this.props.time_limitations.length > 0) {
        ...
        this.props.time_limitations.map((limit, index)=> {
          return(
            <Row className="clearfix time-limitation-row" key={index}>
              <Col md={3}>
                <ControlLabel className='input-sm'>{I18n.t('shared.time_limitations_selector.time_from')}</ControlLabel>
              </Col>
              <Col md={3}>
                <Select
                  name="time_from"
              ...
              <Col md={1}>
                <ControlLabel className='input-sm'>{I18n.t('shared.time_limitations_selector.time_to')}</ControlLabel>
              </Col>
              <Col md={3}>
                <Select
                  name="time_to"
              ...
              <Col md={3}>
                <ControlLabel className='input-sm'>{I18n.t('shared.time_limitations_selector.weekdays')}</ControlLabel>
              </Col>
              <Col md={8}>
                <Select
                  name="time_weekdays"
                  ...
                  placeholder={I18n.t('shared.time_limitations_selector.any_weekday')}
                />
              </Col>
            </Row>
          )
      ...
      return(
        <Row className="clearfix">
          <Col md={12}>
            <Label bsStyle="info">{I18n.t('shared.time_limitations_selector.time_unlimited')}</Label>
          </Col>
        </Row>
      )
    }
