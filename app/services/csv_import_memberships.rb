class CSVImportMemberships < CSVImportBase
  ...
  def process_row(params)
    ...
    membership.errors.add('params', t('failed_to_process_data'))
  ...
  def membership_params(params)
    sanitizer = MembershipTimeSanitizer.new(params) rescue nil
    # pass unprocessable time to membership validation
    start_time = sanitizer.membership_start_time rescue nil
    end_time = sanitizer.membership_end_time rescue nil
